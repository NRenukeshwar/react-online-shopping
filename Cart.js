                ...
                <div className="row border p-2" key={index}>
                  <div className="col-12 col-sm-3 text-center">
                    ...
                    <div>
                      <button
                        ...
                        onClick={event => props.decrementProduct(event, index)}
                      >
                      ...
                      <button
                        className="btn btn-light btn-sm"
                        onClick={event => props.incrementProduct(event, index)}
                      >
                  ...
                  <div className="col-12 col-sm-9">
                    ...
                    <div className="d-flex">
                      <h4>₹{Number(item.cost) * Number(item.quantity)}/- </h4>{" "}
                      &nbsp;
                      <strike className="mt-1">
                        ₹{Number(item.originalcost) * Number(item.quantity)}
                      </strike>
                      &nbsp;&nbsp;
                      <p className="mt-1 text-success font-weight-bold">
                        {item.offer}% off
                      </p>
                    </div>
                    <button
