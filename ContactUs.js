...
function ContactUs() {
  return (
    <div className="container text-center">
      <p
        className="text-warning font-weight-bold mt-5"
        style={{ fontSize: "80px", marginBottom: "0px" }}
      >
        NN
        <span
      ...
      <p className="m-2">
        ...
        <span>
          <i
            ...
            style={{ fontSize: "20px", color: "#139DF9" }}
          />
        </span>{" "}
        NNShopping@gmail.com
      </p>
      <br />
      ...
      <div>
        <p className="mt-3" style={{ color: "#4138BE" }} title="Facebook">
          <span>
            <i className="fab fa-facebook" style={{ fontSize: "40px" }} />
          </span>{" "}
          Facebook
        </p>
        <p style={{ color: "#FF0000" }} title="Google">
          <span>
            <i
        ...
        <p style={{ color: "#139DF9" }} title="Twitter">
          <span>
            <i className="fab fa-twitter-square" style={{ fontSize: "40px" }} />
          </span>{" "}
          Twitter
        </p>
      </div>
