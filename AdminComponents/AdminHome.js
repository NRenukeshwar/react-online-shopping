...
class AdminHome extends React.Component {
  ...
  handleSubmit = event => {
    ...
    axios
      .put(
        "http://localhost:3001/products/" + this.state.editProduct.id,
  ...
  deleteRow = (e, index) => {
    ...
    if (edit.specifications.length > 1) edit.specifications.splice(index, 1);
    this.setState({
      editProduct: edit
    });
  };
  ...
  handleDelete = (event, index) => {
    ...
    axios
      .delete("http://localhost:3001/products/" + this.state.products[index].id)
    ...
    if (this.state.pageLoaded) {
      return (
        <div className="container mt-3">
          <Modal
            ...
            className="container row w-100 modal-lg h-100"
            ...
            <ModalBody>
              <form id="form">
                ...
                <div className="form-group">
                  ...
                  <br />
                  <ol>
                    {this.state.editProduct.specifications.map(
                      (item, sindex) => (
                        <li key={sindex}>
                          ...
                          {sindex ==
                          this.state.editProduct.specifications.length - 1 ? (
                            <button
                              type="button"
                ...
                <div className="form-group">
                  ...
                  <Input
                    ...
                    required
                  />
                  {this.state.editProduct.src.trim() != "" ? (
                    <img
                      src={this.state.editProduct.src}
                      width="150px"
                      height="200px"
                      alt="Image"
                    />
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    className="form-control"
                    value={
                      this.state.editProduct.available ? "available" : "soldout"
                    }
                    onChange={event => {
                      this.handleChange(event);
                    }}
            ...
            {this.state.products.map((product, index) => (
              <div key={product.id} className="row mb-3 mt-1 shadow border">
                <div className="col-12 col-sm-3 m-auto">
                  <img
                    src={product.src}
                    className="d-flex m-1 mx-auto img-fluid"
                    alt={product.name}
                  />
                </div>
                ...
                <div className="col-12 col-sm-7 mt-2">
                  ...
                  >
                    <div
                      id={"descp" + index}
                      className="container mt-2 tab-pane fade"
                    >
                      <h5>Description</h5>
                    ...
                    <div
                      id={"specf" + index}
                      className="container mt-2 tab-pane active"
                    >
                      <h5>Specifications</h5>
                      <ul>
                        {product.specifications.map((spe, index) => (
                          <li key={index}>{spe}</li>
                        ))}
                      </ul>
                    </div>
                ...
                <div className="col-12 col-sm-2 m-auto text-center">
                  <h4>₹{product.cost}</h4>
                  <p>
                    <strike>₹{product.originalcost}</strike> {product.offer}%
                    off
                  </p>
                  <button
      ...
      return (
        <div className="text-warning text-center mt-5">
          <h3>
            <i
              className="fa fa-spinner fa-spin text-success"
              aria-hidden="true"
            />
            Loading...
          </h3>
